...
from vaws_diagnostics import collect_bundle, current_context
...
def execution_bundle(row, reply, diagnostic_events, output):
    ...
    def add(kind, stamp, monotonic, process, attributes, *, correlation=None):
        ...
        records.append({"schema": 1, "component": "vaws-coordinator", "event": kind,
    ...
    from vaws_coordinator.service import _PROCESS_CLOCK_DOMAIN
